...
def renderizar_calculadora():
    ...
    # Puxa o nome automaticamente se o Aluno estiver logado, senão permite digitar (Painel do Professor)
    nome_padrao = st.session_state.get("nome_aluno_calc", "")
    nome_aluno = st.text_input("Digite o primeiro nome do aluno (Detetive):", value=nome_padrao)
    
    st.divider()
    
    # Inputs numéricos e seletores de hábitos
